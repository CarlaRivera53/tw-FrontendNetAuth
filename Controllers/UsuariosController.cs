...
public class  UsuariosController(UsuariosClientService usuarios, RolesClientService roles) : Controller
{
   public async Task<IActionResult> Index()
   {
    ...
    [HttpPost]
    public async Task<IActionResult> CrearAsync(UsarioPwd itemToCreate)
    {
        ...
        ModelState.AddModelError("Email", "No ha sido posible realizar la accion. Intentalo nuevamente");
        await RolesDropDownListAsync();
